...
Route::get('/struk/{id}', [TunggakanController::class, 'struk'])->middleware(['auth'])->name('struk');
Route::get('/exportpdf', [TunggakanController::class, 'exportpdf'])->middleware(['auth'])->name('exportpdf');
